...
$(function () {
  ...
  $('body').on('click', '.js_publisher', function () {
    ...
    local_schedule_date = new Date(local_schedule_date.replace(' ', 'T') + ':00');
    var schedule_date = local_schedule_date.toISOString().slice(0, 19).replace('T', ' ');
    /* get anonymous */
